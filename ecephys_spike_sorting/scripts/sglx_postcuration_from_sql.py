...
npx_directory = os.path.join(r'Z:\Sandra\Data', protocol, 'Spikes', mouse)

# Output destination
# All output will be written here:
json_directory = r'C:\Users\sromeropinto\Documents\Data\ecephys_spike_sorting\json_files'
if os.path.isdir(json_directory) is False:
    os.mkdir(json_directory)
catGT_dest = npx_directory
if os.path.isdir(catGT_dest) is False:
    os.mkdir(catGT_dest)
...
for spec in run_specs:
    ...
    for i, prb in enumerate(prb_list):
        ...
        prb_folder = run_str + '_imec' + prb
        data_directory.append(os.path.join(catGT_dest, run_str, run_folder, prb_folder))
    ...
    print('Results saved in ' + outputSession)
