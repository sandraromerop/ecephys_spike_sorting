...
% paths will get set by the pipeline  # function main_kilosort_multiversion( KSver, remDup, finalSplits, labelGood, saveRez )
...
rP.labelGood = 1;
rP.saveRez =1;
addpath(genpath('C:\Users\sromeropinto\Documents\Codes\Kilosort'))
addpath(genpath('C:\Users\sromeropinto\Documents\Codes\npy-matlab'))
