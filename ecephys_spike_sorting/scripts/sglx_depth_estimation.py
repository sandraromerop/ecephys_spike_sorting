...
mouse = 'SR006'  # 'BS003'
nameSession = 'SR006_10032021_g0'
protocol = 'TonicDA' #'TimeInvestBernoulli'  # 'BeliefState'
...
json_directory = r'C:\Users\sromeropinto\Documents\Codes\ecephys_spike_sorting\json_files'
src = os.path.join(r'Z:\Sandra\Data', protocol, 'Spikes', mouse)

# Output destination
# All output will be written here:
catGT_dest = os.path.join(r'C:\Users\sromeropinto\Documents\Codes\ecephys_spike_sorting\cat_outputs', mouse)
